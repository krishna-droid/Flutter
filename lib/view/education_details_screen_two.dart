...
class EducationDetailsScreenTwo extends StatefulWidget {
  const EducationDetailsScreenTwo({Key? key}) : super(key: key);

  @override
  State<EducationDetailsScreenTwo> createState() =>
      _EducationDetailsScreenTwoState();
}

class _EducationDetailsScreenTwoState extends State<EducationDetailsScreenTwo> {
  @override
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                CommonData().educationDetails[1]["institution"],
                style: const TextStyle(fontWeight: FontWeight.w700),
              ),
              Text(CommonData().educationDetails[1]["degree"]),
              Text(CommonData().educationDetails[1]["timeline"]),
              const SizedBox(
                height: 15,
              ),
              const Text(
